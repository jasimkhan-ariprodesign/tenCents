...
const FhDetails = ({navigation, route}) => {
  ...
  // console.log('FHDetails  last screen for routes selectedTopMenu => ', selectedTopMenu);
    ...
    <SafeAreaView style={styles.parent}>
      ...
      <View style={[styles.parent, {marginTop: _mvs(15)}]}>
        ...
        <View style={styles.bottomFixedView}>
          <View style={{rowGap: _mvs(3), flex: 1}}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              // navigation.navigate(refName === 'f&h' ? 'fhbr' : 'chpd')
              navigation.navigate(selectedTopMenu === 'h&c' ? 'chpd' : 'fhbr')
            }>
            <Text

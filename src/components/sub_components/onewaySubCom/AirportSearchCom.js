...
const AirportSearchCom = ({
  oneWayHandler,
  handleAirportSearchInput,
  setOneWayHandler,
          ...
          <View style={onewayStyles.child}>
            ...
            <View style={onewayStyles.searchFieldWrapper}>
              ...
              <TextInput
                ...
                value={oneWayHandler.origin}
                onChangeText={value => {
                  // setOneWayHandler({...oneWayHandler, origin: value});
                  handleAirportSearchInput(value, 'Origin');
                }}
              />
          ...
          <View style={onewayStyles.child}>
            ...
            <View style={onewayStyles.searchFieldWrapper}>
              ...
              <TextInput
                ...
                style={onewayStyles.originInput}
                // autoFocus={true}
                value={oneWayHandler.destination}
                onChangeText={value => {
                  // setOneWayHandler({...oneWayHandler, destination: value});
                  handleAirportSearchInput(value, 'Destination');
                }}
              />
...
export default AirportSearchCom;

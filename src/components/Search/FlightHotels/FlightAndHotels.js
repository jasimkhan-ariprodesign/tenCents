      ...
      <View style={styles.mainMenuWrap}>
        ...
        {selectedTopMenu == 'f&h' && (
          <View style={{marginHorizontal: 10, marginTop: 0}}>
            {selectedMidMenu === 'o' && (
              <OneWay navigation={navigation} dest={'opt2'} />
            )}
            {selectedMidMenu === 'r' && (
              <RoundTrip navigation={navigation} dest={'opt2'} />
            )}
          </View>
        )}
          ...
          <View style={{marginHorizontal: 10}}>
            <Text style={[commonStyles.ns400, {color: b3, lineHeight: 19}]}>
              *All fares above were last found on:{' '}
              <Text style={{color: '#CB3926', fontFamily: 'Arial'}}>
                Oct 02, 2023 at 12:10:59 AM
              </Text>
              . These are based on average nightly rates and airfare includes
              all fuel surcharges, taxes & fees and our service fees. Hotels,
              rental cars and activities may have additional taxes and fees.
              Displayed rates are based on historical data, are subject to
              change, and cannot be guaranteed at the time of booking. See all
              booking{' '}
              <Text
                onPress={() => Alert.alert('t&c')}
                style={{
                  color: blue,
                  fontFamily: 'Arial',
